@MixinConfigOption(description = "Optimize item entity merging by categorizing item entities by item type and only attempting to"
        +
        " merge with the same type. Categorizing by stack size allows skipping merge attempts of full item" +
        " entities or two more than half full item entities.", depends = {
