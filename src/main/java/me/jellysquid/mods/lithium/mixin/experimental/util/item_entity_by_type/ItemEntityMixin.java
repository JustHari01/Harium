...
public abstract class ItemEntityMixin extends Entity {
    ...
    @Redirect(method = "setStack", at = @At(value = "INVOKE", target = "Lnet/minecraft/entity/data/DataTracker;set(Lnet/minecraft/entity/data/TrackedData;Ljava/lang/Object;)V"))
    private <T> void handleItemTypeChange(DataTracker dataTracker, TrackedData<T> key, T newStack) {
        ...
        if (newItem != ((ItemStackAccessor) (Object) oldStack).lithium$getItem()) {
            ((NotifyingItemStack) (Object) oldStack).lithium$notifyAfterItemEntityStackSwap((ItemEntity) (Object) this,
                    oldStack);
        }
    }
}
