...
public abstract class TypeFilterableListMixin<T> extends AbstractCollection<T>
        implements TypeFilterableListInternalAccess<T> {
    ...
    @Override
    public <S extends T> List<S> lithium$replaceCollectionAndGet(Class<S> type,
            Function<ArrayList<S>, List<S>> listCtor) {
